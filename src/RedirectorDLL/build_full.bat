...
echo Compiling Redirector.dll with MinHook sources...
cl.exe /LD /Fe:Redirector.dll dllmain.cpp buffer.c hde32.c hook.c trampoline.c /D "_CRT_SECURE_NO_WARNINGS" /link /OUT:Redirector.dll user32.lib ws2_32.lib advapi32.lib
