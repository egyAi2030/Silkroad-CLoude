...
- **Coverage thresholds apply** — Enforced via `.coverage-thresholds.json` as a blocking gate before PR creation and task completion
- Test command: `dotnet test`
- Coverage command: `dotnet test /p:CollectCoverage=true /p:CoverletOutputFormat=cobertura`
...
- C# Coding Standards (Roslyn Analyzers)
